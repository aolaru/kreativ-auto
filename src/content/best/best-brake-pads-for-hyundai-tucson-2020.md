...
faqs:
  - question: "What is the safest brake pad choice for a Hyundai Tucson?"
    answer: "A quiet ceramic pad from a reputable supplier is the safest default for normal Tucson commuter use."
  - question: "Should I buy purely on price?"
    answer: "No. Fitment, hardware service, and low-noise street behavior matter more than the cheapest pad set."
fitment:
  appliesTo:
  ...
  phaseDifferences:
    - "Treat the TL-era notes as the baseline and confirm supplier splits when ordering."
  powertrainDifferences:
    - "The broad shortlist logic still applies, but exact compatibility can vary by powertrain and package."
---

Most Hyundai Tucson owners do not need the most dramatic parts option. They need the one that solves the real complaint cleanly and still makes sense in everyday use. That is the filter behind this shortlist.
