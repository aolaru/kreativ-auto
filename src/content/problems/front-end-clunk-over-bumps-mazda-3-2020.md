...
canYouDrive: "Usually yes for short-term driving, but the noise should be diagnosed before the wear spreads or confidence in the front end drops"
...
quickVerdict: "A Mazda 3 front-end clunk over bumps is usually a smaller suspension-hardware problem before it becomes a larger front-end job."
firstCheck: "Start with the sway bar links and nearby front-end hardware because that is the cleanest first failure point."
confusedWith:
...
faqs:
  ...
  - question: "Can I keep driving with a mild front-end clunk?"
    answer: "Usually yes in the short term, but it is better to catch the first worn part before the noise spreads through the rest of the front end."
fitment:
  appliesTo:
