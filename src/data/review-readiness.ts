...
import { cx30BestQuality, cx30GuideQuality, cx30ProblemQuality } from "./mazda-cx30-quality";
...
export const reviewReadyGuideIds = combineKeys(rav4GuideQuality, hondaCivicGuideQuality, highlanderGuideQuality, cx30GuideQuality);
...
export const reviewReadyProblemIds = combineKeys(highlanderProblemQuality, cx30ProblemQuality);
export const reviewReadyBestIds = combineKeys(rav4BestQuality, hondaCivicBestQuality, highlanderBestQuality, cx30BestQuality);
export const reviewReadyCarIds = new Set(["toyota-rav4-2020", "toyota-rav4-2021", "honda-civic-2019", "toyota-highlander-2020", "mazda-cx-30-2020"]);
